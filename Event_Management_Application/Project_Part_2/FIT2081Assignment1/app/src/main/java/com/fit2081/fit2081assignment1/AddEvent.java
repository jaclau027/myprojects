...
public class AddEvent extends AppCompatActivity {
    ...
    public void saveButtonClick(View view) {
        ...
        if (categoryIdString.equals("") || eventNameString.equals("") || ticketsString.equals("0")){
            ...
            saveDataToSharedPreference(eventIdString, categoryIdString, eventNameString, ticketsInteger, activeBool);
    ...
    private void saveDataToSharedPreference(String eventIdValue, String categoryIdValue, String eventNameValue, int ticketsValue, boolean activeValue) {
